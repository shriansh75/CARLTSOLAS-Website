...
/**
 * Defers expensive children (WebGL, OGL, Rive) until the slot approaches the
 * viewport. Pair with next/dynamic({ ssr: false }) imports so heavy runtimes
 * stay out of the shared bundle entirely. Ported from the SOLAS MODU sibling.
 */
